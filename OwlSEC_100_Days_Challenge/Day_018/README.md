...
> The Binary File Contained the Header `<SALEAE>`    
>     
> after some googling we come across Saleae.com, a company that makes hardware analysing tools.    
> In the Downloads Section I find an appimage for: `Saleae Logic 2`, and so i downloaded it.    
> we imported the .sal file to the application and at this point, i had no idea what to do    
>     
> So I found a walkthrough for the challenge, as well as learned a bit about the SALEAE Logic 2 software.    
> In the End We used a tool called "Async Serializer", Calculated a Bitrate, and Viewed it within the terminal view    
>     
> at the bottom was the flag we were looking for.    
...
__**𝒩**𝑒𝓍𝓉 𝒮𝓉𝑒𝓅𝓈__        
-# *Learn More About Salae Logic 2*        
